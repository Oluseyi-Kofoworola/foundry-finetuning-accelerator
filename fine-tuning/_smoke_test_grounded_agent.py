...
ACCOUNT  = os.environ.get("AZURE_RESOURCE_NAME", "aif-foundry-labs")
...
run_turn(
    ...
    user_msg="Hi this is Jamie Example, DOB 7/12/1982, member MEM-099. Can you refill my metformin and ship it mail order?",
    fake_tool_outputs={
        "verify_member_identity": json.dumps({"verified": True, "memberId": "MEM-099", "fullName": "Jamie Example"}),
