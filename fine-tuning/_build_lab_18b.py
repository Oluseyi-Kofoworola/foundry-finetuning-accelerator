...
def lab18b() -> list[dict]:
    return [
        ...
        md(
            ...
            "to the agent team. The flow stops if no live vision result is available; "
            "it never substitutes a canned clinical impression.\n"
        ),
        code(
            "impression = None\n"
            ...
            "    except Exception as e:\n"
            "        raise RuntimeError('Vision read failed; no impression was generated.') from e\n"
            "\n"
            "if not impression:\n"
            "    raise RuntimeError('Vision model unavailable or returned an empty impression.')\n"
            "print(impression)\n"
        ),
        md(
        ...
        md(
            ...
            "fields** while measuring prompt-token reduction at runtime.\n\n"
        ...
        code(
            ...
            "     'Reliable structured RECIST fields; token reduction is measured below.'),\n"
            "]\n"
