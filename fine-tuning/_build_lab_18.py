...
def lab18() -> list[dict]:
    return [
        ...
        code(
            ...
            "            model=MODEL, name='sutter-rx-specialist',\n"
            "            instructions=(\n"
            "                'You are the Sutter Prescriptions specialist. You handle refills, '\n"
            ...
            "            model=MODEL, name='sutter-coverage-specialist',\n"
            "            instructions=(\n"
            "                'You are the Sutter Coverage & Billing specialist. You answer copay, '\n"
        ...
        code(
            ...
            "            model=MODEL, name='sutter-triage-orchestrator',\n"
            "            instructions=('You are the Sutter Member Services triage agent. For each '\n"
        ...
        md(
            ...
            "set `SUTTER_WORKFLOW_NAME` to its name (or edit below). Until a workflow "
        ...
        code(
            ...
            "# publish it, then set SUTTER_WORKFLOW_NAME to invoke it by reference.\n"
            "WORKFLOW_NAME = os.environ.get('SUTTER_WORKFLOW_NAME', '')  # e.g. 'sutter-member-services-flow'\n"
            "\n"
            "try:\n"
            ...
            "    print('[skip] set SUTTER_WORKFLOW_NAME (or edit this cell) to a published workflow name.')\n"
            "else:\n"
