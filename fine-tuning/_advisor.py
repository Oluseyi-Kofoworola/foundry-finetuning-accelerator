...
class WorkloadClassifier:
    ...
    def _llm_refine(self, text: str) -> list[str]:
        ...
        # Replace this with an Microsoft Foundry Agent SDK call if you adopt agents.
        """
        try:
...
def try_build_client() -> Any:
    ...
    # Replace this with an Microsoft Foundry Agent SDK client if you adopt agents.
    """
    endpoint = os.environ.get("AZURE_OPENAI_ENDPOINT")
    if not endpoint:
        return None
    try:
        ...
        return AzureOpenAI(
            ...
            timeout=float(os.environ.get("AZURE_OPENAI_TIMEOUT_SECONDS", "30")),
            max_retries=int(os.environ.get("AZURE_OPENAI_MAX_RETRIES", "1")),
        )
