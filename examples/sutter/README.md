# Reference Client: Sutter Health (healthcare)

This folder is a **worked example** of how to white-label the accelerator for a
customer. It reproduces the original healthcare demo ("Sutter Health") that ships
with this repo.
...
voice-agent app and the fine-tuning labs. See [docs/CUSTOMIZATION.md](../../docs/CUSTOMIZATION.md)
