...
export interface ToolContext {
  ...
  memberId?: string;
  scenarioId: string;
  /** Scenario-scoped allowlist; required for every tool execution. */
...
export const ConfigSchema = z.object({
  ...
  brand: z.object({
    ...
    productName: z.string().default('Acme Health AI Assistant'),
    assistantName: z.string().default('Acme Health AI Assistant'),
