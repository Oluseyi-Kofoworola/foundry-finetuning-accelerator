 ...
 * pain points and demonstrate how an Microsoft Foundry-grounded agent enforces
 * identity tiers, content safety, and explicit handoff.
 *
 * Scenarios:
 *   1. acme-mho-front-door         — Acme Health Portal front door
...
// =============================================================================
// 1. ACME Acme Health Portal — PATIENT ACCESS FRONT DOOR
// =============================================================================
...
export const acmeMhoFrontDoorScenario: ScenarioDefinition = {
  ...
  description:
    'Patient access voice agent for the ACME Acme Health Portal (MHO) front door. ' +
  ...
  systemPrompt: `You are "Acme Health AI Assistant", the Acme Health patient access voice agent.
...
export const acmeBilingualAccessScenario: ScenarioDefinition = {
  ...
  systemPrompt: `You are "Acme Health AI Assistant" operating in multilingual mode.
