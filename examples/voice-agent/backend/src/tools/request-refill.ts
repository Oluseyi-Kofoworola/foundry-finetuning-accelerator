...
>({
  ...
  The first call stages the exact request. Read it back to the patient, wait for explicit confirmation,
  ...
  parameters: {
    ...
    properties: {
      ...
      confirmationToken: {
        type: 'string',
        description: 'One-time token returned by the staged request after the patient explicitly confirms it',
      },
    },
