...
BRAND_ASSISTANT_NAME=Acme Health AI Assistant
```
...
|-----------|------|-----|-----|------|
| MEM-001 | Alex Example | 01/15/1985 | 63101 | Gold |
...
| `BRAND_ASSISTANT_NAME` | Assistant display name | `Acme Health AI Assistant` |
