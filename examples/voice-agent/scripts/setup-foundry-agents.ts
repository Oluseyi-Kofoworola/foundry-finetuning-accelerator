 ...
 * 
 * This script creates the multi-agent system in Microsoft Foundry
...
const agentConfigs: AgentConfig[] = [
  {
    ...
    displayName: 'Acme Health AI Assistant',
    description: 'Main orchestrator that routes healthcare requests to specialized agents',
    instructions: `You are the Acme Health AI Assistant, the primary AI assistant for healthcare operations.
...
- Always offer to help with anything else`,
  ...
  
  {
    ...
    displayName: 'Acme Health Pharmacy Assistant',
...
- Override prior authorization requirements`,
  ...
  
  {
    ...
    displayName: 'Acme Health Health Plan Concierge',
...
- Recommend specific doctors over others`,
  ...
  
  {
    ...
    displayName: 'Acme Health Provider-Facing Assistant',
...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log('  4. Test agents in Microsoft Foundry Portal: https://ai.azure.com');
