#!/usr/bin/env python3
"""
Microsoft Foundry Agents - Create & Manage Multi-Agent System
Acme Health - Healthcare Operations

This script creates and manages AI agents in the modern AIServices-based
Microsoft Foundry. Uses the new endpoint-based initialization.
...
if not PROJECT_ENDPOINT:
    raise SystemExit(
        "AZURE_AI_PROJECT_ENDPOINT is not set. Copy backend/.env.example to "
        "backend/.env and set it to your own Foundry project endpoint, e.g. "
...
agents_config = [
    {
        ...
        "instructions": """You are the Acme Health AI Assistant - the primary point of contact for all member interactions.
...
print("Using Microsoft Foundry Agents SDK (v1)")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        if len(agents) == len(agents_config):
            print("\n✓ All agents ready in Microsoft Foundry!")
