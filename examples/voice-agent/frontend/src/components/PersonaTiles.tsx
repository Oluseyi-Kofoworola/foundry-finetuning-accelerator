...
export const DEMO_PERSONAS: DemoPersona[] = [
  {
    ...
    name: 'Alex Example',
    age: 38,
    plan: `${brand.shortName} Gold PPO`,
    conditions: ['Type 2 Diabetes', 'Hypertension'],
    opener:
      "Hi, this is Alex Example. My member ID is MEM-001 and I need to check on my prescription refills.",
  ...
  },
  {
    ...
    age: 62,
    plan: `${brand.shortName} Platinum Premier`,
  ...
  },
  {
    ...
    name: 'Emily Chen',
    age: 28,
    plan: `${brand.shortName} Silver HMO`,
